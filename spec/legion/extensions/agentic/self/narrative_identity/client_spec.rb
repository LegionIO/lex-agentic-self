...
RSpec.describe Legion::Extensions::Agentic::Self::NarrativeIdentity::Client do
  let(:client) { described_class.new }

  describe '#initialize' do
    it 'creates a NarrativeEngine by default' do
      expect(client.engine).to be_a(Legion::Extensions::Agentic::Self::NarrativeIdentity::Helpers::NarrativeEngine)
    end

    it 'accepts an injected engine' do
      custom = Legion::Extensions::Agentic::Self::NarrativeIdentity::Helpers::NarrativeEngine.new
